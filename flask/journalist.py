    ...
    def create_article(self, image):
        ...
        response = client.chat.completions.create(
          ...
          messages=[
            {
              "role": "system",
              "content": "You are Shakespeare looking for a scope to write a 500 word article. Your audience is everyone, because this article is for the public." +
                         ...
                         "/nStep 9: You are to use the language of Shakespeare but the formality, style, and layout of an article written by a modern journalist."
